...
export function CreateDoctorModal() {
  ...
  const onSubmit: SubmitHandler<FormData> = async (data) => {
    ...
    toast("Médico registrado com sucesso!")

    console.log({ ...data, roleName, availableTimesItems, specialtiesItems })
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <DialogFooter>
          <Button className="bg-blue-600" type="button" onClick={handleSubmit(onSubmit)}>Registrar médico</Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
  )
